       ...
       <div class="InventoryInputContainer">
            ...
            <div class="InventoryForm">
                ...
                <div class="InventoryInputs">
                    ...
                    <div id="message" style="font-family: Arial, Helvetica, sans-serif; font-size: large; font-weight: bold; font-style: normal; font-variant: normal; color: #000000; margin-bottom : 5px; margin_top:5px; text-transform: capitalize;"></div> 
                    <div id="message1" style="border-style: none; font-family: Arial, Helvetica, sans-serif; font-size: large; font-weight: bold; font-style: normal; font-variant: normal; color: #000000; margin-bottom : 5px"></div> 
                    <div id="message2" style="font-family: Arial, Helvetica, sans-serif; font-size: large; font-weight: bold; font-style: normal; font-variant: normal; color: #000000; margin-bottom:25px"></div> 
